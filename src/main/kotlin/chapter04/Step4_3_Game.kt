...
private fun printPlayerStatus(
    ...
    val statusFormatString =
        "(HP: $healthPoints)(Aura: $auraColor)(Blessed: ${if (isBlessed) "YES" else "NO"} -> $name $healthStatus"
...
private fun castFireBall(numOfFireBalls: Int = 2) = println("한 덩어리의 Fire Ball 이 나타단다. (x$numOfFireBalls)")